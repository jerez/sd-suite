...
This repository keeps shared agent instructions in `AGENTS.md` and `CLAUDE.md`.
If you want local notes or personal preferences for your current checkout, put
them in `AGENTS.override.md` or `CLAUDE.local.md` and leave them untracked.
