...
import { audioInputApi as windowsAudioInputApi, audioOutputApi as windowsAudioOutputApi } from "./windows";
 ...
 */
export async function subscribeDefaultInputDeviceChanges(listener: () => void): Promise<() => void> {
